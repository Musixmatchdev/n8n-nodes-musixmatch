...
1. Visit [Musixmatch API Pricing](https://www.musixmatch.com/pro/api/pricing?utm_source=github_n8n_node&utm_medium=web&utm_content=pricing_page_link) to view available plans
